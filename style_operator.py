...
class Stylized(object):
    ...
    def init_params(self, style_size):
        self.style_dir = '/data/user/data/painting/train/'
        self.num_styles = 1
        # self.alpha = 1.0
        ...
        self.crop = 0
        self.decoder_path = '/data/user/data/painting/pretrained_models/decoder.pth'
        self.vgg_path = '/data/user/data/painting/pretrained_models/vgg_normalised.pth'
